...
public class MahasiswaJFrame extends javax.swing.JFrame {
    ...
    Connection salsa = koneksi.KoneksiDatabase.BukaKoneksi(); //fungsi untuk melakukan koneksi ke database mysql
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Data Mahasisswa");
        ...
        try {
            ...
            if (btnsimpan.getText()=="Simpan") {
                ...
                String Update = "UPDATE tblmahasiswa SET nama ='" + txtnama.getText() +
                        "', harga ='" +txtalamat.getText()+
                        "', stok ='" +txtprodi.getText()+
